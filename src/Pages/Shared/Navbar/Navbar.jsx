...
const Navbar = () => {
    ...
    return (
        <div className="navbar bg-slate-300 bg-opacity-40">
            <div className="navbar-start">
                <div className="dropdown">
                    <div tabIndex={0} role="button" className="btn btn-ghost lg:hidden">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h8m-8 6h16" /></svg>
                    </div>
                    <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-white rounded-box w-52 text-black font-semibold">
                        {navLinks}
                    </ul>
                </div>
                    ...
                    user ?
                        <div className='flex items-center'>
                            ...
                            <div className="dropdown dropdown-end">
                                ...
                                <ul tabIndex={0} className="menu menu-md dropdown-content mt-3 z-[1] p-2 shadow bg-white rounded-box">
                                    <li>
                                        {
                                            isAdmin ? (
