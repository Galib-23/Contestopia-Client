        ...
        <div className='bg-white'>
            <div className="hero min-h-screen" style={{ backgroundImage: `url(${expectrum})` }}>
                ...
                <div className="hero-content">
                    <div className="">
                        ...
                        <div className='px-10 py-16 bg-white rounded-2xl shadow-2xl flex flex-col md:flex-row items-center justify-between'>
            ...
            <div className='mb-20'>
                ...
                <div className='mx-2 md:mx-32 space-y-7'>
                    <div className='flex flex-col md:flex-row items-center justify-between bg-white rounded-2xl shadow-lg p-10'>
                        <div className='space-y-3'>
